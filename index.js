...
function DebounceRequest(fn, interval, isSameRequest) {
    ...
    if (isSameRequest === void 0) { isSameRequest = true; }
    var curTime;
    var preTime;
    var res = new Map();
...
var mockRequest = function (res) { return new Promise(function (resolve) {
    console.log('发了请求');
    setTimeout(function () {
        resolve(res);
    }, 200);
}); };
var request = DebounceRequest(mockRequest, 1000, false);
// async function exec() {
